<template>
    <div class="news-home">
        <div class="news-home-header">
            <lamp-header-mobile title="Новости" link="/ru/novosti" link-description="Все новости"></lamp-header-mobile>
        </div>
        <div class="news-home-body d-block flex-wrap">
            <div class="news-home-row col-12" v-for="news in newsList">
