    ...
    <div class="trainer-row">
        ...
        <div class="price-list col-12">
            <trainer-cost-button-mobile
                    ...
                    :show="trainingType === cost.lessonType"
...
export default {
    name: "TrainerRowMobile",
    components: {
        TrainerRowVideoSliderMobile,
        TrainerCostButtonMobile, TrainerRank, TrainerCostButton, TrainerRowVideoSlider},
    inject: [
        'header'
    ],
    props: [
