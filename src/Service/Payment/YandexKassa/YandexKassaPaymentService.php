...
class YandexKassaPaymentService extends EntityService
{
    ...
    public function createPayment(Lessons $lesson, float $amount, string $redirect, string $description = 'Оплата за урок'): ?CreatePaymentResponse
    {
        $client = new Client();
