...
!function () {
    ...
    var e, t, n, r, o, i, a, u, s, c, l, f, d, m, p, g, h, v = function (e) {
    ...
    }, C = V.never, x = V.always, w = function () {
        return N
    }, N = (r = {
        fold: function (e, t) {
            return e()
        ...
        }, or: n, orThunk: t, map: w, ap: w, each: function () {
        }, bind: w, flatten: w, exists: C, forall: x, filter: w, equals: e = function (e) {
            return e.isNone()
        }, equals_: e, toArray: function () {
            return []
        }, toString: V.constant("none()")
    }, Object.freeze && Object.freeze(r), r), E = function (n) {
        var e = function () {
            return n
        }, t = function () {
            return o
        ...
        return -1
    }, I = Array.prototype.push, M = function (e) {
        ...
        return !0
    }, z = Array.prototype.slice, U = k.isFunction(Array.from) ? Array.from : function (e) {
        return z.call(e)
    }, H = {
        map: _, each: B, eachr: D, partition: function (e, t) {
    ...
    }, q = "undefined" != typeof window ? window : Function("return this;")(), j = function (e, t) {
    ...
    }, Y = navigator, G = Y.userAgent, J = function (e) {
    ...
    var Q, Z, ee, te, ne, re, oe, ie, ae, ue, se, ce, le, fe, de, me, pe, ge, he, ve = {
        ...
        y.bind = function (e, t, n, r) {
            ...
            var r;
            if (!e || 3 === e.nodeType || 8 === e.nodeType) return y;
            for ((n = Re(null, n)).type = t, n.target = e; (r = e[p]) && C(n, r), (e = e.parentNode || e.ownerDocument || e.defaultView || e.parentWindow) && !n.isPropagationStopped();) ;
            return y
        }, y.clean = function (e) {
            var t, n, r = y.unbind;
            if (!e || 3 === e.nodeType || 8 === e.nodeType) return y;
    ...
    var De = "sizzle" + -new Date, Oe = window.document, Pe = 0, Le = 0, Ie = pt(), Me = pt(), Fe = pt(),
        ze = function (e, t) {
            return e === t && (ce = !0), 0
        }, Ue = typeof undefined, qe = {}.hasOwnProperty, Ve = [], He = Ve.pop, je = Ve.push, $e = Ve.push,
        We = Ve.slice, Ke = Ve.indexOf || function (e) {
        ...
        Ze = new RegExp("^" + Xe + "*," + Xe + "*"), et = new RegExp("^" + Xe + "*([>+~]|" + Xe + ")" + Xe + "*"),
        tt = new RegExp("=" + Xe + "*([^\\]'\"]*?)" + Xe + "*\\]", "g"), nt = new RegExp(Je),
        rt = new RegExp("^" + Ye + "$"), ot = {
            ID: new RegExp("^#(" + Ye + ")"),
            CLASS: new RegExp("^\\.(" + Ye + ")"),
            TAG: new RegExp("^(" + Ye + "|[*])"),
        ...
        }, it = /^(?:input|select|textarea|button)$/i, at = /^h\d$/i, ut = /^[^{]+\{\s*\[native \w/,
        st = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ct = /[+~]/, lt = /'|\\/g,
        ft = new RegExp("\\\\([\\da-f]{1,6}" + Xe + "?|(" + Xe + ")|.)", "ig"), dt = function (e, t, n) {
            var r = "0x" + t - 65536;
    ...
    for (Z in ee = mt.support = {}, re = mt.isXML = function (e) {
        ...
        var t, s = e ? e.ownerDocument || e : Oe, n = s.defaultView;
            ...
            TAG: function (e) {
                ...
                return 1 === p && 0 === g ? function (e) {
                    ...
                    if (l) {
                        ...
                        } else if (d && (r = (e[De] || (e[De] = {}))[m]) && r[0] === Pe) a = r[1]; else for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[De] || (i[De] = {}))[m] = [Pe, a]), i !== e));) ;
    ...
    }).pseudos.nth = te.pseudos.eq, {radio: !0, checkbox: !0, file: !0, password: !0, image: !0}) te.pseudos[Z] = vt(Z);
    ...
    function Nt(a, e, t) {
        var u = e.dir, s = t && "parentNode" === u, c = Le++;
    ...
    function kt(m, p, g, h, v, e) {
        return h && !h[De] && (h = kt(h)), v && !v[De] && (v = kt(v, e)), gt(function (e, t, n, r) {
            var o, i, a, u = [], s = [], c = t.length, l = e || function (e, t, n) {
                    ...
                    return n
                }(p || "*", n.nodeType ? [n] : n, []), f = !m || !e && p ? l : St(l, u, m, n, r),
                d = g ? v || (e ? m : c || h) ? [] : t : f;
            if (g && g(f, d, n, r), h) for (o = St(d, s), h(o, [], n, r), i = o.length; i--;) (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
            if (e) {
                if (v || m) {
                    if (v) {
    ...
    function Tt(e) {
        for (var r, t, n, o = e.length, i = te.relative[e[0].type], a = i || te.relative[" "], u = i ? 1 : 0, s = Nt(function (e) {
            ...
            if ((t = te.filter[e[u].type].apply(null, e[u].matches))[De]) {
                ...
                return kt(1 < u && Et(l), 1 < u && wt(e.slice(0, u - 1).concat({value: " " === e[u - 2].type ? "*" : ""})).replace(Qe, "$1"), t, u < n && Tt(e.slice(u, n)), n < o && Tt(e = e.slice(n)), n < o && wt(e))
            }
            l.push(t)
        }
        return Et(l)
    ...
    xt.prototype = te.filters = te.pseudos, te.setFilters = new xt, oe = mt.tokenize = function (e, t) {
        ...
        var o, i, a, u, s, c = "function" == typeof e && e, l = !r && oe(e = c.selector || e);
        if (n = n || [], 1 === l.length) {
    ...
    var At = Array.isArray, Rt = function (e, t, n) {
            var r, o;
            if (!e) return 0;
            ...
            trim: Ot, isArray: Bt.isArray, is: Pt, toArray: Bt.toArray, makeMap: function (e, t, n) {
                var r;
        ...
        }, Mt = document, Ft = Array.prototype.push, zt = Array.prototype.slice,
        Ut = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, qt = Be.Event, Vt = It.makeMap("children,contents,next,prev"),
        Ht = function (e) {
            return void 0 !== e
        }, jt = function (e) {
            ...
            var o;
            if (jt(t)) t = $t(t, un(e[0])); else if (t.length && !t.nodeType) {
                if (t = tn.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) Wt(e, t[o], n, r); else for (o = 0; o < t.length; o++) Wt(e, t[o], n, r);
                return e
            }
        ...
        Jt = {"for": "htmlFor", "class": "className", readonly: "readOnly"}, Qt = {"float": "cssFloat"}, Zt = {},
        en = {}, tn = function (e, t) {
            return new tn.fn.init(e, t)
        }, nn = /^\s*|\s*$/g, rn = function (e) {
    ...
    tn.fn = tn.prototype = {
        constructor: tn, selector: "", context: null, length: 0, init: function (e, t) {
            var n, r, o = this;
            if (!e) return o;
            ...
            if (jt(e)) {
                ...
                if (n[1]) for (r = $t(e, un(t)).firstChild; r;) Ft.call(o, r), r = r.nextSibling; else {
            ...
            if (!1 !== t) for (n = tn.unique(o.toArray().concat(tn.makeArray(e))), o.length = n.length, r = 0; r < n.length; r++) o[r] = n[r]; else Ft.apply(o, tn.makeArray(e));
            return o
        }, attr: function (t, n) {
            var e, r = this;
            ...
            if ("object" == typeof n) on(n, function (e, t) {
                ...
                var e = this.style;
                if ((o = en[n]) && o.set) o.set(this, r); else {
                    try {
                        this.style[Qt[n] || n] = r
                    } catch (t) {
                    }
        ...
        }, push: Ft, sort: [].sort, splice: [].splice
    }, It.extend(tn, {
        extend: It.extend,
    ...
    var sn = function (e, t, n) {
        ...
        var o = [];
        for (r instanceof tn && (r = r[0]); e; e = e[t]) if (!n || e.nodeType === n) {
            if (r !== undefined) {
                if (e === r) break;
    ...
    var dn, mn = function (e) {
            ...
            nu: hn, detect: function (e, t) {
                var n = String(t).toLowerCase();
                return 0 === e.length ? gn() : pn(e, n)
            }, unknown: gn
        }, yn = "Firefox", bn = function (e, t) {
            return function () {
                return t === e
            }
        }, Cn = function (e) {
        ...
        }, wn = "Windows", Nn = "Android", En = "Solaris", Sn = "FreeBSD", kn = function (e, t) {
            return function () {
                return t === e
            }
        }, Tn = function (e) {
        ...
        }, Pn = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, Ln = function (t) {
            return function (e) {
                return Dn(e, t)
            }
        }, In = [{
        ...
        }, {name: "Opera", versionRegexes: [Pn, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: Ln("opera")}, {
            name: "Firefox",
            versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/],
            search: Ln("firefox")
        }, {
            name: "Safari", versionRegexes: [Pn, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
        ...
        Fn = {browsers: V.constant(In), oses: V.constant(Mn)}, zn = function (e) {
            var t, n, r, o, i, a, u, s, c, l, f, d = Fn.browsers(), m = Fn.oses(), p = _n(d, e).fold(xn.unknown, xn.nu),
        ...
        }, Hn = 8, jn = 9, $n = 1, Wn = 3, Kn = function (e) {
        ...
        }, Gn = Yn($n), Jn = Yn(Wn), Qn = Yn(jn), Zn = {
            name: Kn, type: Xn, value: function (e) {
            ...
            body: fr, getBody: dr, inBody: function (e) {
            ...
            immutable: function () {
                ...
                return Er("required", o), Er("optional", i), Sr(a), function (t) {
                    var n = ir.keys(t);
            ...
            eq: Lr, isEqualNode: function (e, t) {
        ...
        }, jr = kr.immutable("element", "offset"), $r = {
            owner: Fr, defaultView: function (e) {
                ...
                for (var n = k.isFunction(t) ? t : V.constant(!1), r = e.dom(), o = []; null !== r.parentNode && r.parentNode !== undefined;) {
                    var i = r.parentNode, a = Vn.fromDom(i);
        ...
        }, Wr = Un.detect().browser, Kr = function (e) {
    ...
    var uo, so, co, lo = function (t) {
        ...
        }, To = No(3), Ao = No(8), Ro = No(9), _o = So("br"), Bo = ko("true"), Do = ko("false"), Oo = {
            isText: To,
            isElement: Eo,
            isComment: Ao,
            isDocument: Ro,
        ...
        }, Io = {trimNode: Lo}, Mo = It.makeMap,
        Fo = /[&<>\"\u0060\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
        zo = /[<>&\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g, Uo = /[<>&\"\']/g,
        qo = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi, Vo = {
            128: "\u20ac",
            130: "\u201a",
            131: "\u0192",
            132: "\u201e",
    ...
    var jo = function (e, t) {
        ...
        }, Xo = {}, Yo = {}, Go = It.makeMap, Jo = It.each, Qo = It.extend, Zo = It.explode, ei = It.inArray,
        ti = function (e, t) {
            ...
            var u, t, n, r, o, i, s = {}, a = function (e, t, n) {
                ...
                var n, r, o, i;
                for (n = (e = ti(e)).length, t = ti(t); n--;) for (r = s[e[n]], o = 0, i = t.length; o < i; o++) r.attributes[t[o]] = {}, r.attributesOrder.push(t[o])
            };
            ...
            var r;
            return e && (r = {}, "string" == typeof e && (e = {"*": e}), Jo(e, function (e, t) {
    ...
    function oi(i) {
        ...
        var S = function (e) {
            ...
            var t, n, r, o, i, a, u, s, c, l, f, d, m, p, g, h, v, y, b,
                C = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
                x = /^([!\-])?(\w+[\\:]:\w+|[^=:<]+)?(?:([=:<])(.*))?$/, w = /[*?+]/;
            if (e) for (e = ti(e, ","), N["@"] && (h = N["@"].attributes, v = N["@"].attributesOrder), t = 0, n = e.length; t < n; t++) if (i = C.exec(e[t])) {
            ...
            Xo[i.schema] = null, e && Jo(ti(e, ","), function (e) {
                var t, n, r = o.exec(e);
                r && (n = r[1], t = n ? p[r[2]] : p[r[2]] = {"#comment": {}}, t = p[r[2]], Jo(ti(r[3], "|"), function (e) {
                    "-" === n ? delete t[e] : t[e] = {}
                }))
            })
        }, w = function (e) {
    ...
    var ui, si = It.each, ci = It.grep, li = ve.ie, fi = /^([a-z0-9],?)+$/i, di = /^[ \t\r\n]*$/,
        mi = function (n, r, o) {
    ...
    function hi(a, u) {
        ...
        var r = {}, i = window, o = {}, t = 0, e = function (m, e) {
            ...
            }, D = Ko.decode, O = Ko.encodeAllRaw, P = function (e, t) {
                var n = h(e);
    ...
    var vi = hi, yi = vi.DOM, bi = It.each, Ci = It.grep, xi = function (e) {
    ...
    var ki, Ti = "\ufeff", Ai = function (e) {
            return e === Ti
        }, Ri = Ti, _i = function (e) {
            return e.replace(new RegExp(Ti, "g"), "")
        }, Bi = Oo.isElement, Di = Oo.isText, Oi = function (e) {
            ...
            var t, n
        }, Hi = Oo.isContentEditableTrue, ji = Oo.isContentEditableFalse, $i = Oo.isBr, Wi = Oo.isText,
        Ki = Oo.matchNodeNames("script style textarea"),
        Xi = Oo.matchNodeNames("img input textarea hr iframe video audio object"), Yi = Oo.matchNodeNames("table"),
        Gi = Li, Ji = function (e) {
        ...
        }, pa = Oo.isElement, ga = Ji, ha = Oo.matchStyleValues("display", "block table"),
        va = Oo.matchStyleValues("float", "left right"), ya = da.and(pa, ga, da.negate(va)),
        ba = da.negate(Oo.matchStyleValues("white-space", "pre pre-line pre-wrap")), Ca = Oo.isText, xa = Oo.isBr,
        wa = vi.nodeIndex, Na = ua, Ea = function (e) {
            ...
            if (pa(e.container())) if (e.isAtEnd()) n = Na(e.container(), e.offset()), Ca(n) && i(n, n.data.length), ya(n) && !xa(n) && o(_a(Ra(n), !1)); else {
    ...
    function Da(t, n, e) {
        ...
        return {
            container: da.constant(t), offset: da.constant(n), toRange: function () {
                var e;
    ...
    var Oa, Pa, La = Da, Ia = Oo.isElement, Ma = Oo.isText, Fa = function (e) {
        var t = e.parentNode;
        t && t.removeChild(e)
    }, za = function (e, t) {
    ...
    }, Za = Oo.isContentEditableTrue, eu = Oo.isContentEditableFalse, tu = function (e, t, n, r, o) {
        ...
        var r = Ss(1, e.getBody(), t), o = La.fromRangeStart(r), i = o.getNode();
    ...
    var iu, au, uu = function (e, t) {
        ...
        }, du = V.curry(su, Da.isAbove, -1), mu = V.curry(su, Da.isBelow, 1), pu = V.curry(cu, -1, du),
        gu = V.curry(cu, 1, mu), hu = function (e, t) {
            return Pr.all(t, e)
            ...
            if (u = {elm: t, alignToTop: n}, e.fire("scrollIntoView", u), !u.isDefaultPrevented() && Oo.isElement(t)) {
        ...
        }, ju = Un.detect().browser, $u = function () {
        ...
        }, Xu = da.curry(Ku, du), Yu = da.curry(Ku, mu), Gu = function (e, t, n, r) {
            ...
            var o, i, a, u, s, c, l = e.selection.getRng(), f = La.fromRangeStart(l), d = e.getBody();
            if (!t && Xu(r, f)) {
        ...
        }, rs = Oo.isContentEditableFalse, os = function (e, t, n) {
            ...
            var t, s, c = ns(A.none()), l = function () {
                !function (e) {
                    var t, n, r, o, i;
        ...
        ss = Oo.matchStyleValues("display", "block table table-cell table-caption list-item"), cs = Li, ls = Oi,
        fs = da.curry, ds = Oo.isElement, ms = Ji, ps = function (e) {
            return 0 < e
        }, gs = function (e) {
            return e < 0
        }, hs = function (e, t) {
            ...
            return null
        }, Ns = fs(xs, !0), Es = fs(xs, !1), Ss = function (e, t, n) {
            var r, o, i, a, u = fs(ws, !0, t), s = fs(ws, !1, t);
        ...
        }, _s = fs(ks, 0), Bs = fs(ks, -1), Ds = fs(Ts, 0), Os = fs(Ts, -1);
    (au = iu || (iu = {}))[au.Backwards = -1] = "Backwards", au[au.Forwards = 1] = "Forwards";
    var Ps, Ls, Is, Ms, Fs, zs = Oo.isContentEditableFalse, Us = Oo.isText, qs = Oo.isElement, Vs = Oo.isBr, Hs = Ji,
        js = function (e) {
            return Xi(e) || !!Qi(t = e) && !0 !== Bt.reduce(t.getElementsByTagName("*"), function (e, t) {
                return e || Hi(t)
            }, !1);
            var t
        }, $s = Zi, Ws = function (e, t) {
            ...
            var n = La.after(e), r = Ys(t).prev(n);
            ...
            var n, r, a, u, s, c, l, f, d, m, p, g, h, v, y, b, C, x, w,
                ...
                E = Zs(o, i.startContainer), S = Qs(Gs(N.firstChild)), k = o.getRoot(), T = function (e) {
                    var t = La.fromRangeStart(i), n = Ys(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
            ...
            return !!Zs(e, t)
        }, ic = Oo.isText, ac = Oo.isBogus, uc = vi.nodeIndex, sc = function (e) {
            var t = e.parentNode;
            return ac(t) ? sc(t) : t
        }, cc = function (e) {
        ...
        }, pc = Oo.isContentEditableFalse, gc = function (e, t, n, r, o) {
            ...
            return r.insertNode(l), hc(l.previousSibling), e.moveToBookmark({id: o, keep: 1}), {id: o}
        }, Ec = {
            ...
            var t = hu(e, "br"), n = H.filter(function (e) {
    ...
    var Qc = function (a) {
        var u = La.fromRangeStart(a), s = La.fromRangeEnd(a), c = a.commonAncestorContainer;
    ...
    }, el = Oo.matchNodeNames("td th"), tl = function (o, e, t) {
    ...
    var ol = function (e, t, n) {
        ...
        }, sl = kr.immutable("sections", "settings"), cl = Un.detect().deviceType.isTouch(),
        ll = ["lists", "autolink", "autosave"], fl = {theme: "mobile"}, dl = function (e) {
            var t = k.isArray(e) ? e.join(" ") : e, n = H.map(k.isString(t) ? t.split(" ") : [], On);
            ...
            var o, i, a = dl(n.forced_plugins), u = dl(r.plugins),
        ...
        }, vl = V.curry(hl, k.isString), yl = function (e, t, n, r) {
            ...
            return ma([Qa.firstPositionIn(u), Qa.lastPositionIn(u)], function (e, t) {
                var n = xl.normalizePosition(!0, e), r = xl.normalizePosition(!1, t), o = xl.normalizePosition(!1, a);
            ...
            var n
        }, Dl = Oo.hasAttribute("data-mce-bookmark"), Ol = Oo.hasAttribute("data-mce-bogus"),
        Pl = Oo.hasAttributeValue("data-mce-bogus", "all"), Ll = function (e) {
            return function (e) {
                var t, n, r = 0;
                if (Bl(e, e)) return !1;
        ...
        }, Il = kr.immutable("block", "position"), Ml = kr.immutable("from", "to"), Fl = function (e, t) {
            var n = Vn.fromDom(e), r = Vn.fromDom(t.container());
            return wl(n, r).map(function (e) {
                return Il(e, t)
            })
        }, zl = function (o, i, e) {
            var t = Fl(o, La.fromRangeStart(e)), n = t.bind(function (e) {
            ...
            var n = Vn.fromDom(t), r = V.curry(Mr.eq, e);
            ...
            var n, r, o, t, i = Vn.fromDom(e.getBody()), a = e.selection.getRng();
        ...
        of = function (e, t, n, r) {
            ...
            return Oo.isContentEditableTrue(n) && e.dom.isBlock(n) && e.dom.isEmpty(n) && (t = e.dom.create("br", {"data-mce-bogus": "1"}), e.dom.setHTML(n, ""), n.appendChild(t), e.selection.setRng(La.before(t).toRange())), !0
        }, wf = Oo.isText, Nf = function (e) {
        ...
        }, Tf = V.curry(kf, !0), Af = V.curry(kf, !1), Rf = function (e, t) {
        ...
        Pf = function (e, t) {
            ...
            var r = xl.normalizeForwards(n), o = Pf(t, r.container());
            ...
            var r = xl.normalizeBackwards(n), o = Pf(t, r.container());
            return xl.findRootInline(e, o, r).fold(function () {
            ...
            var e = xl.normalizePosition(a, c), l = Vf(u, s, e);
        ...
        }, Gf = Vf, Jf = Yf, Qf = (V.curry(Yf, !1), V.curry(Yf, !0), $f), Zf = function (e) {
            ...
            var n = t.selection.getRng(), r = e ? La.fromRangeEnd(n) : La.fromRangeStart(n);
            ...
            move: function (a, u, s) {
                ...
                var u = ns(null), s = V.curry(xl.isInlineTarget, a);
            ...
            var u = r.getBody(), s = V.curry(xl.isInlineTarget, r);
            ...
            var e, t, a = (e = n.getBody(), t = o.container(), ys(t, e) || e), u = V.curry(xl.isInlineTarget, n),
                s = Gf(u, a, o);
            return s.bind(function (e) {
                ...
                var t = Qa.navigate(i, a, o), e = t.bind(function (e) {
                    return Gf(u, a, e)
                });
                return s.isSome() && e.isSome() ? xl.findRootInline(u, a, o).map(function (e) {
                    return o = e, !!ma([Qa.firstPositionIn(o), Qa.lastPositionIn(o)], function (e, t) {
                        var n = xl.normalizePosition(!0, e), r = xl.normalizePosition(!1, t);
            ...
            return !1
        }, md = kr.immutable("start", "end"), pd = kr.immutable("rng", "table", "cells"),
        gd = nf([{removeTable: ["element"]}, {emptyCells: ["cells"]}]), hd = function (e, t) {
            ...
            var t = hd(e.startContainer, r), n = hd(e.endContainer, r);
            ...
            var n, r, o, i, a, u = Vn.fromDom(e.selection.getStart(!0)), s = Ld(e);
            ...
            getFontSize: Yd("font-size"), getFontFamily: V.compose(function (e) {
            ...
            var n = t.collapsed, r = t.cloneRange(), o = Da.fromRangeStart(t);
            ...
            var n, r, o,
                i = (n = e, r = V.curry(xl.isInlineTarget, n), o = La.fromRangeStart(n.selection.getRng()), Gf(r, n.getBody(), o).filter(gm));
        ...
        xm = kr.immutable("start", "soffset", "finish", "foffset"), wm = {
            domRange: Cm.domRange, relative: Cm.relative, exact: Cm.exact, exactFromRange: function (e) {
        ...
        }, Nm = Un.detect().browser, Em = function (e, t) {
        ...
        }, zm = It.each, Um = It.extend, qm = It.map, Vm = It.inArray;
    ...
    function Hm(s) {
        ...
        e({
            "mceResetDesignMode,mceBeginUndoLevel": function () {
                ...
                var r, o;
                o = n, (r = s).formatter.toggle("fontname", {value: Zd(r, o)}), r.nodeChanged()
            }, FontSize: function (e, t, n) {
                var r, o;
                o = n, (r = s).formatter.toggle("fontsize", {value: Zd(r, o)}), r.nodeChanged()
    ...
    var jm = It.makeMap("focus blur focusin focusout click dblclick mousedown mouseup mousemove mouseover beforepaste paste cut copy selectionchange mouseout mouseenter mouseleave wheel keydown keypress keyup input contextmenu dragstart dragend dragover draggesture dragdrop drop drag submit compositionstart compositionend compositionupdate touchstart touchmove touchend", " "),
        $m = function (a) {
            ...
            var r = function (e, t, n, r) {
                var o, i, a;
                if (!1 === t && (t = f), t) for (t = {func: t}, r && It.extend(t, r), a = (i = e.toLowerCase().split(" ")).length; a--;) e = i[a], (o = l[e]) || (o = l[e] = [], s(e, !0)), n ? o.unshift(t) : o.push(t);
                return c
            }, m = function (e, t) {
                var n, r, o, i, a;
    ...
    var Wm, Km = function (n) {
            ...
            fire: function (e, t, n) {
                ...
                if (t = Km(this).fire(e, t, n), !1 !== n && this.parent) for (var r = this.parent(); r && !t.isPropagationStopped();) r.fire(e, t, !1), r = r.parent();
                return t
            }, on: function (e, t, n) {
            ...
            return Qm(e, "class", t)
        }, np = Zm, rp = ep, op = tp, ip = function (e, t) {
            ...
            add: function (e, t) {
                ...
                var n, r, o, i, a, u, s = ap(e), c = e.dom().classList;
                return n = function () {
                    s ? c.remove(t) : op(e, t)
                }, r = function () {
                    s ? c.add(t) : rp(e, t)
        ...
        }, Np = wp = It.extend({}, Xm, wp), Ep = It.each, Sp = It.explode, kp = {f9: 120, f10: 121, f11: 122},
    ...
    var Rp = function (e) {
        ...
        }, zp = Ip, Up = function (e, t) {
            return t.dom()[e]
        }, qp = function (e, t) {
            return parseInt(br(t, e), 10)
        }, Vp = V.curry(Up, "clientWidth"), Hp = V.curry(Up, "clientHeight"), jp = V.curry(qp, "margin-top"),
        $p = V.curry(qp, "margin-left"), Wp = function (e, t, n) {
            var r, o, i, a, u, s, c, l, f, d, m = Vn.fromDom(e.getBody()), p = e.inline ? m : $r.documentElement(m),
    ...
    var Gp = Si.PluginManager, Jp = function (e, t) {
        var n = function (e, t) {
            for (var n in Gp.urls) if (Gp.urls[n] + "/plugin" + t + ".js" === e) return n;
            return null
        }(t, e.suffix);
    ...
    }, og = Si.PluginManager, ig = Si.ThemeManager;
    ...
    function ug(u, s) {
        ...
        return s = It.extend({credentials: !1, handler: n}, s), {
            upload: function (e, t) {
    ...
    var Ng = function (e, t) {
        ...
        if (f = d.forced_root_block, v && Oo.isElement(v) && f && (l = y.nodeName.toLowerCase(), g.isValidChild(l, f.toLowerCase()) && (b = h, C = y, x = v, !H.exists(Hl(Vn.fromDom(x), Vn.fromDom(C)), function (e) {
            ...
            var b, C, x, w, N;
            for (n = (t = p.getRng()).startContainer, r = t.startOffset, o = t.endContainer, i = t.endOffset, c = zp(e), v = y.firstChild; v;) if (w = h, N = v, Oo.isText(N) || Oo.isElement(N) && !Ng(w, N) && !Mc(N)) {
                if (Eg(h, v)) {
        ...
        return ma([(i = e, a = i.startContainer, u = i.startOffset, Oo.isText(a) ? 0 === u ? A.some(Vn.fromDom(a)) : A.none() : A.from(a.childNodes[u]).map(Vn.fromDom)), (t = e, n = t.endContainer, r = t.endOffset, Oo.isText(n) ? r === n.data.length ? A.some(Vn.fromDom(n)) : A.none() : A.from(n.childNodes[r - 1]).map(Vn.fromDom))], function (e, t) {
            var n = H.find(Tg(o), V.curry(Mr.eq, e)), r = H.find(Ag(o), V.curry(Mr.eq, t));
            return n.isSome() && r.isSome()
        }).getOr(!1);
        var t, n, r, i, a, u
    }, _g = function (e, t, n, r) {
        var o = n, i = new ao(n, o), a = e.schema.getNonEmptyElements();
        do {
    ...
    var Og, Pg, Lg = function (e) {
        ...
        var n, r, o, i, a, u
    }, Mg = Oo.isContentEditableFalse, Fg = Oo.isContentEditableTrue, zg = function (e) {
        ...
        t = vi.DOM, a = document, n = Ug(c, e), g = c, h = e, v = we.throttle(function (e, t) {
            ...
            if (g.dragging) {
                var p = (f = g, {pageX: (d = Ig(h, e)).pageX - f.relX, pageY: d.pageY + 5});
    ...
    var Wg = function (o, i, a, e, u, t) {
        var n, s, c = 0, l = [], r = function (e) {
            var t, n, r;
            for (r = $g([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++) if (n = r[t], !a(n, s)) {
    ...
    }, Kg = V.curry(Wg, Og.Up, oa, ia), Xg = V.curry(Wg, Og.Down, ia, oa), Yg = function (n) {
        return function (e) {
            return t = n, e.line > t;
            var t
        }
    ...
    }, Jg = Oo.isContentEditableFalse, Qg = vs, Zg = function (e, t) {
    ...
    }, ch = Oo.isContentEditableTrue, lh = Oo.isContentEditableFalse, fh = Bs, dh = _s, mh = function (e, t) {
        ...
        var g, e, t, a = p.getBody(), o = is(p.getBody(), function (e) {
        ...
        return ve.ceFalse && (function () {
            ...
            var n, r, i = function (e, t) {
                ...
                return !(!o || !p.dom.isChildOf(o, i) || !1 !== lh(mh(p, o))) || o && (n = o, r = i, !(p.dom.getParent(n, p.dom.isBlock) === p.dom.getParent(r, p.dom.isBlock))) && function (e) {
                    ...
                    var n = La.before(e.firstChild), r = t.next(n);
                    return r && !dh(r) && !fh(r)
                }(o)
            };
            r = !1, (n = p).on("touchstart", function () {
                ...
                var t, n = e.target;
                if ((n === a || "HTML" === n.nodeName || p.dom.isChildOf(n, a)) && !1 !== Wp(p, e.clientX, e.clientY)) if (t = mh(p, n)) lh(t) ? (e.preventDefault(), c(nu(p, t))) : (l(), ch(t) && e.shiftKey || ih(e.clientX, e.clientY, p.selection.getRng()) || (C(), p.selection.placeCaretAt(e.clientX, e.clientY))); else if (!1 === as(n)) {
                    l(), C();
    ...
    function hh(F, z) {
        ...
        var U = F.comment ? F.comment : e, q = F.cdata ? F.cdata : e, V = F.text ? F.text : e,
            H = F.start ? F.start : e, j = F.end ? F.end : e, $ = F.pi ? F.pi : e, W = F.doctype ? F.doctype : e;
        return {
            parse: function (e) {
                    ...
                    if (_ < t.index && V(O(e.substr(_, t.index - _))), n = t[6]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), I(n); else if (n = t[7]) {
                        ...
                        if (":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), c = n in s, R && E[n] && 0 < B.length && B[B.length - 1].name === n && I(n), !g || (l = z.getElementRule(n))) {
                            if (f = !0, g && (y = l.attributes, b = l.attributePatterns), (v = t[8]) ? ((m = -1 !== v.indexOf("data-mce-type")) && u && (f = !1), (d = []).map = {}, v.replace(k, M)) : (d = []).map = {}, g && !m) {
                                if (C = l.attributesRequired, x = l.attributesDefault, w = l.attributesForced, l.removeEmptyAttrs && !d.length && (f = !1), w) for (o = w.length; o--;) a = (h = w[o]).name, "{$uid}" === (A = h.value) && (A = "mce_" + D++), d.map[a] = A, d.push({
                                    name: a,
                                    value: A
                                });
                                if (x) for (o = x.length; o--;) (a = (h = x[o]).name) in d.map || ("{$uid}" === (A = h.value) && (A = "mce_" + D++), d.map[a] = A, d.push({
                                    name: a,
                                    value: A
                                }));
                                if (C) {
    ...
    var vh = hh, yh = function (e, t) {
        ...
        return _i(l)
    }, bh = {trimExternal: yh, trimInternal: yh}, Ch = 0, xh = 2, wh = 1, Nh = function (p, g) {
    ...
    }, _h = Rh, Bh = function (e, t) {
        var n = $r.owner(e).dom(), r = Vn.fromDom(n.createDocumentFragment()), o = Ah(t, n);
        qc(r, o), Hc.empty(e), Hu.append(e, r)
    }, Dh = ns(A.none()), Oh = function (e) {
    ...
    function Uh(u) {
        ...
        return u.on("init", function () {
            ...
            data: l, typing: !1, beforeChange: function () {
                ...
                var e;
                return o.typing && (o.add(), o.typing = !1, i(!1)), 0 < c && (e = l[--c], Fh(u, e, !0), d(!0), u.fire("undo", {level: e})), e
            }, redo: function () {
                var e;
                return c < l.length - 1 && (e = l[++c], Fh(u, e, !1), d(!0), u.fire("redo", {level: e})), e
            }, clear: function () {
    ...
    var qh, Vh, Hh = function (e) {
        ...
        isInlineBlock: Hh, moveStart: function (e, t, n) {
            var r, o, i, a = n.startOffset, u = n.startContainer;
            if ((n.startContainer !== n.endContainer || !Hh(n.startContainer.childNodes[n.startOffset])) && 1 === u.nodeType) for (a < (i = u.childNodes).length ? r = new ao(u = i[a], e.getParent(u, e.isBlock)) : (r = new ao(u = i[i.length - 1], e.getParent(u, e.isBlock))).next(!0), o = r.current(); o; o = r.next()) if (3 === o.nodeType && !jh(o)) return n.setStart(o, 0), void t.setRng(n)
    ...
    }, Kh = Mc, Xh = Wh.getParents, Yh = Wh.isWhiteSpaceNode, Gh = Wh.isTextBlock, Jh = function (e, t) {
        ...
        var i, a, u, s;
        for (3 === r.nodeType && 0 === r.nodeValue.length && r[o] && (r = r[o]), i = Xh(e, r), a = 0; a < i.length; a++) for (u = 0; u < t.length; u++) if (!("collapsed" in (s = t[u]) && s.collapsed !== n.collapsed) && e.is(i[a], s.selector)) return i[a];
        return r
    }, nv = function (t, e, n, r) {
        ...
        if (o && e[0].wrapper && (o = Xh(i, o, "ul,ol").reverse()[0] || o), !o) for (o = n; o[r] && !i.isBlock(o[r]) && (o = o[r], !Wh.isEq(o, "br"));) ;
        return o || n
        ...
        for (; ;) {
            ...
            for (c = s[l]; c; c = c[l]) if (!Kh(c) && !Yh(c) && ("BR" !== (d = c).nodeName || !d.getAttribute("data-mce-bogus") || d.nextSibling)) return s;
        ...
        } else for (s = 0; s < c.length; s++) if ("attributes" === r ? e.getAttrib(t, c[s]) : Wh.getStyle(e, t, c[s])) return n;
        return n
    }, lv = function (e, t, n, r, o) {
        var i, a, u, s, c = e.formatter.get(n), l = e.dom;
        if (c && t) for (a = 0; a < c.length; a++) if (i = c[a], sv(e.dom, t, i) && cv(l, t, i, "attributes", o, r) && cv(l, t, i, "styles", o, r)) {
            if (s = i.classes) for (u = 0; u < s.length; u++) if (!e.dom.hasClass(t, s[u])) return;
            return i
        }
    }, fv = {
        matchNode: lv, matchName: sv, match: function (e, t, n, r) {
            var o;
            ...
            if (u) for (n = e.selection.getStart(), r = Wh.getParents(s, n), i = u.length - 1; 0 <= i; i--) {
    ...
    }, pv = Ri, gv = "_mce_caret", hv = function (e) {
        return 0 < function (e) {
            for (var t = []; e;) {
        ...
        var t;
        if (e) for (e = (t = new ao(e, e)).current(); e; e = t.next()) if (3 === e.nodeType) return e;
        return null
    }, yv = function (e) {
        ...
        var r = e.dom, o = r.getParent(n, da.curry(Wh.isTextBlock, e));
    ...
    var Rv = function (e, t) {
    ...
    }, Dv = /^(src|href|style)$/, Ov = It.each, Pv = Wh.isEq, Lv = function (e) {
        ...
        if ("all" !== n.remove) for (Ov(n.styles, function (e, t) {
        ...
        var t, n, d = s.formatter.get(c), m = d[0], a = !0, u = s.dom, r = s.selection, o = function (e) {
            ...
            var t, n, r, o, i;
            if (Oo.isElement(e) && u.getContentEditable(e) && (o = a, a = "true" === u.getContentEditable(e), i = !0), t = It.grep(e.childNodes), a && !i) for (n = 0, r = d.length; n < r && !zv(s, d[n], l, e, e); n++) ;
            if (m.deep && t.length) {
            ...
            if (e = ov(s, e, d, !0), m.split) {
                if ((t = Iv(s, e, !0)) !== (n = Iv(s, e))) {
                    ...
                    t = Mv(u, t, "span", {id: "_start", "data-mce-type": "bookmark"}), n = Mv(u, n, "span", {
                        id: "_end",
                        "data-mce-type": "bookmark"
                    }), o(t), o(n), t = i(!0), n = i()
                } else t = n = o(t);
    ...
    }, ry = It.each, oy = function (p, g, h, r) {
            ...
            b = function (n, e) {
                ...
                l = y.inline || y.block, f = s.create(l), b(f), Bv(s, e, function (e) {
                    var a, u = function (e) {
                        ...
                        if (y.wrapper && fv.matchNode(p, e, g, h)) a = 0; else {
    ...
    }, iy = {applyFormat: oy}, ay = It.each, uy = function (e, t, n, r, o) {
        var i, a, u, s, c, l, f, d;
        null === t.get() && (a = e, u = {}, (i = t).set({}), a.on("NodeChange", function (n) {
            var r = Wh.getParents(a.dom, n.element), o = {};
    ...
    }, cy = It.each, ly = vi.DOM, fy = function (e, t) {
        var n, o, r, m = t && t.schema || oi({}), p = function (e) {
            var t, n, r;
            ...
            if (u = d, s = "string" != typeof (a = n) ? a.nodeName.toLowerCase() : a, c = m.getElementRule(s), i = !(!(l = c && c.parentsRequired) || !l.length) && (u && -1 !== It.inArray(l, u) ? u : l[0])) d === i ? (o = e[0], e = e.slice(1)) : o = i; else if (f) o = e[0], e = e.slice(1); else if (!t) return n;
        ...
        return e && "string" == typeof e ? (e = (e = e.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), It.map(e.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
            var t = It.map(e.split(/(?:~\+|~|\+)/), dy), n = t.pop();
    ...
    var yy = function (a) {
            ...
            process: function (e, t, n) {
                ...
                }), o = "BODY" !== o.nodeName ? u.body.firstChild : u.body, s = c.doc, c.doc = u), cp(r, xy.merge(i, {node: o})), s && (c.doc = s), o) : t;
        ...
        Ry = function (e, t, n) {
            ...
            g.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
                var r, o, i, a, u, s, c, l, f = e.length, d = It.extend({}, h.getBlockElements()),
                ...
                if (!g.allow_unsafe_link_target) for (; o--;) "a" === (t = e[o]).name && "_blank" === t.attr("target") && t.attr("rel", (n = t.attr("rel"), r = n ? It.trim(n) : "", /\b(noopener)\b/g.test(r) ? r : r.split(" ").filter(function (e) {
                    return 0 < e.length
        ...
        }, My = It.makeMap, Fy = It.each, zy = It.explode, Uy = It.extend;
        ...
        var D = function (e) {
            ...
            schema: T, addAttributeFilter: function (e, n) {
                ...
                if (t.parse(e), h && m.length && (a.context ? a.invalid = !0 : function (e) {
                    ...
                    for (d = My("tr,td,th,tbody,thead,tfoot,table"), l = T.getNonEmptyElements(), f = T.getWhiteSpaceElements(), m = T.getTextBlockElements(), p = T.getSpecialElements(), t = 0; t < e.length; t++) if ((n = e[t]).parent && !n.fixed) if (m[n.name] && "li" === n.parent.name) {
    ...
    var Vy = function (e, t, n) {
        ...
        var r = n.selection ? xy.merge({forced_root_block: !1}, n) : n, o = e.parse(t, r);
        return wy.trimTrailingBr(o), o
    }, $y = function (e, t, n, r, o) {
        var i, a, u, s, c = (i = r, Jc(t, n).serialize(i));
        return a = e, s = c, !(u = o).no_events && a ? lp(a, xy.merge(u, {content: s})).content : s
    };

    function Wy(e, t) {
        var a, u, s, c, l, n,
            r = (a = e, n = ["data-mce-selected"], s = (u = t) && u.dom ? u.dom : vi.DOM, c = u && u.schema ? u.schema : oi(a), a.entity_encoding = a.entity_encoding || "named", a.remove_trailing_brs = !("remove_trailing_brs" in a) || a.remove_trailing_brs, l = qy(a, c), wy.register(l, a, s), {
                schema: c,
                addNodeFilter: l.addNodeFilter,
                addAttributeFilter: l.addAttributeFilter,
                serialize: function (e, t) {
                    var n = xy.merge({format: "html"}, t || {}), r = Ny.process(u, e, n), o = Hy(s, r, n),
                        i = jy(l, o, n);
    ...
    var Xy = Ky, Yy = Oo.isContentEditableFalse, Gy = Oo.isContentEditableTrue, Jy = function (r, a) {
            var u, s, c, l, f, d, m, p, g, h, v, y, i, b, C, x, w, N = a.dom, E = It.each, S = a.getDoc(), k = document,
            ...
            return tb(e, !1)
        }, ob = nb, ib = function (e, t) {
            var n = (t || document).createDocumentFragment();
            return H.each(e, function (e) {
                n.appendChild(e.dom())
            }), Vn.fromDom(n)
        }, ab = kr.immutable("element", "width", "rows"), ub = kr.immutable("element", "cells"),
        sb = kr.immutable("x", "y"), cb = function (e, t) {
            ...
            for (var n = e.rows(), r = 0; r < n.length; r++) for (var o = n[r].cells(), i = 0; i < o.length; i++) if (Mr.eq(o[i], t)) return A.some(sb(i, r));
            return A.none()
            ...
            var n, r = Vn.fromDom(t.commonAncestorContainer), o = jl(r, e), i = H.filter(o, function (e) {
                    return po(e) || fo(e)
                }), a = hb(o, t),
            ...
            return (t = e, n = o[0], kl(n, "table", V.curry(Mr.eq, t))).bind(function (e) {
                var t = o[0], n = o[o.length - 1], r = mb(e);
            ...
            var n, r = e.selection.getRng(), o = e.dom.create("body"), i = e.selection.getSel(), a = eb(e, Ad(i));
            ...
            var n, t, l, f, a, r = function (e, t) {
                ...
                getSelectedBlocks: function (e, t) {
                    return function (e, t, n, r) {
                        var o, i, a = [];
                        if (i = e.getRoot(), n = e.getParent(n || Sb(i, t, !1), e.isBlock), r = e.getParent(r || kb(i, t, !1), e.isBlock), n && n !== i && a.push(n), n && r && n !== r) for (var u = new ao(o = n, i); (o = u.next()) && o !== r;) e.isBlock(o) && a.push(o);
        ...
        }, Db = Oo.isContentEditableFalse, Ob = aa, Pb = Bs, Lb = _s, Ib = function (e, t) {
            for (; t = e(t);) if (t.isVisible()) return t;
            return t
        }, Mb = function (e, t, n, r) {
            var o, i, a, u, s, c, l = e === iu.Forwards, f = l ? Lb : Pb;
            ...
            if (d) {
                var m = function (e, t, n, r) {
                    var o, i, a, u, s, c, l = Ys(t), f = [], d = 0, m = function (e) {
            ...
            var r, o, i, a, u = Ys(e.getBody()), s = da.curry(Ib, u.next), c = da.curry(Ib, u.prev);
            ...
            return function () {
                var e, t, n, r, o, i, a, u, s,
                    c = (t = f, r = Ys((e = l).getBody()), o = da.curry(Ib, r.next), i = da.curry(Ib, r.prev), a = t ? iu.Forwards : iu.Backwards, u = t ? o : i, s = e.selection.getRng(), (n = Mb(a, e, u, s)) ? n : (n = zb(e, a, s)) || null);
                return !!c && (l.selection.setRng(c), !0)
            }
        }, qb = function (u, s) {
            return function () {
                var e, t, n, r, o, i,
                    a = (r = (t = s) ? 1 : -1, o = t ? Xg : Kg, i = (e = u).selection.getRng(), (n = Fb(r, e, o, i)) ? n : (n = zb(e, r, i)) || null);
            ...
            i.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && (t = i, n = a, r = e, o = Un.detect().os, jb([{
                    keyCode: sh.RIGHT,
                    action: Ub(t, !0)
                }, {keyCode: sh.LEFT, action: Ub(t, !1)}, {keyCode: sh.UP, action: qb(t, !1)}, {
                    keyCode: sh.DOWN,
                    action: qb(t, !0)
                }, {keyCode: sh.RIGHT, action: es(t, !0)}, {keyCode: sh.LEFT, action: es(t, !1)}, {
                    keyCode: sh.UP,
                    action: ts(t, !1)
                }, {keyCode: sh.DOWN, action: ts(t, !0)}, {keyCode: sh.RIGHT, action: sd.move(t, n, !0)}, {
                    keyCode: sh.LEFT,
            ...
            var o, i, a, u, s = V.curry(Sv, t), c = H.map(H.filter(r, s), function (e) {
                return e.dom()
            });
            ...
            var t, e = Vn.fromDom(n.getBody()), o = Vn.fromDom(n.selection.getStart()),
            ...
            o.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && (t = o, n = i, r = e, jb([{
                    ...
                    keyCode: sh.BACKSPACE,
                    action: Hb(Yb, t, !1)
                }, {keyCode: sh.DELETE, action: Hb(Yb, t, !0)}], r).each(function (e) {
                    r.preventDefault()
                }))
                ...
                !1 === e.isDefaultPrevented() && (t = o, n = e, jb([{
                    keyCode: sh.BACKSPACE,
                    action: Hb(xf, t)
                }, {keyCode: sh.DELETE, action: Hb(xf, t)}], n))
            })
        }, Jb = function (e) {
            ...
            if (n !== e.getBody()) {
                ...
                if (aC(n, r, !0) && aC(n, r, !1)) rC(n, "LI") ? i.insertAfter(l, iC(n)) : i.replace(l, n); else if (aC(n, r, !0)) rC(n, "LI") ? (i.insertAfter(l, iC(n)), l.appendChild(i.doc.createTextNode(" ")), l.appendChild(n)) : n.parentNode.insertBefore(l, n); else if (aC(n, r, !1)) i.insertAfter(l, iC(n)); else {
                    n = iC(n);
                    var f = a.cloneRange();
            ...
            var t, u, s, i, c, n, r, o, l, f, d, m, p, g, h, v, y, b, C = a.dom, x = a.schema, w = x.getNonEmptyElements(),
                N = a.selection.getRng(), E = function (e) {
                    ...
                    if (e || "TABLE" === f || "HR" === f ? (t = C.create(e || m), mC(a, t)) : t = c.cloneNode(!1), r = t, !1 === Mu(a)) C.setAttrib(t, "style", null), C.setAttrib(t, "class", null); else do {
                        if (i[o.nodeName]) {
                            if (kc(o)) continue;
            ...
            um(C, N).each(function (e) {
                ...
                var i, a, u, s, c, l, f, d = t || "P", m = e.dom, p = dC(m, r);
            ...
            return gC(e, Iu(e))
        }, yC = nf([{br: []}, {block: []}, {none: []}]), bC = function (e, t) {
            return vC(e)
        }, CC = function (n) {
            return function (e, t) {
                return "" === Ou(e) === n
            ...
            var t = Ou(e), n = Zb(e.dom, e.selection.getStart());
    ...
    function UC(u) {
        var s, n, r, o = It.each, c = sh.BACKSPACE, l = sh.DELETE, f = u.dom, d = u.selection, e = u.settings,
            t = u.parser, i = ve.gecko, a = ve.ie, m = ve.webkit, p = "data:text/mce-internal,", g = a ? "Text" : "URL",
            h = function (e, t) {
                try {
    ...
    var qC = function (e) {
            ...
            t.on("click", function (e) {
                3 === e.detail && function (e) {
                    var t = e.selection.getRng(), n = Da.fromRangeStart(t), r = Da.fromRangeEnd(t);
        ...
        }, jC = vi.DOM, $C = function (e) {
            var t;
            e.bindPendingEventDelegates(), e.initialized = !0, e.fire("init"), e.focus(!0), e.nodeChanged({initial: !0}), e.execCallback("init_instance_callback", e), (t = e).settings.auto_focus && we.setEditorTimeout(t, function () {
                var e;
        ...
        }, sx = It.each, cx = It.trim,
        lx = "source protocol authority userInfo user password host port relative path directory file query anchor".split(" "),
        fx = {ftp: 21, http: 80, https: 443, mailto: 25}, dx = function (r, e) {
            var t, n, o = this;
            if (r = cx(r), t = (e = o.settings = e || {}).base_uri, /^([\w\-]+):([^\/]{2})/i.test(r) || /^\s*#/.test(r)) o.source = r; else {
                var i = 0 === r.indexOf("//");
    ...
    dx.prototype = {
        setPath: function (e) {
            ...
            var t;
            if ("./" === e) return e;
            if ("mce_host" !== (e = new dx(e, {base_uri: this})).host && this.host !== e.host && e.host || this.port !== e.port || this.protocol !== e.protocol && "" !== e.protocol) return e.getURI();
    ...
    var mx = function (e, t, n) {
        var r, o, i, a, u;
        if (t.format = t.format ? t.format : "html", t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) r = It.trim(bh.trimExternal(e.serializer, n.innerHTML)); else if ("text" === t.format) r = _i(n.innerText || n.textContent); else {
        ...
        e.dom.setHTML(e.getBody(), t), zp(r = e) && Qa.firstPositionIn(r.getBody()).each(function (e) {
            var t = e.getNode(), n = Oo.isTable(t) ? Qa.firstPositionIn(t).getOr(e) : e;
    ...
    }, Nx = vi.DOM, Ex = It.extend, Sx = It.each, kx = It.resolve, Tx = ve.ie, Ax = function (e, t, n) {
    ...
    var Rx, _x, Bx, Dx = {
            ...
            Px(t), t.on("focusin", function () {
                ...
                t = e.target, n && t.ownerDocument === document && (t === document.body || Mx(n, t) || r.focusedEditor !== n || (n.fire("blur", {focusedEditor: null}), r.focusedEditor = null))
        ...
        }, jx = vi.DOM, $x = It.explode, Wx = It.each, Kx = It.extend, Xx = 0, Yx = !1, Gx = [], Jx = [],
        Qx = function (t) {
            ...
            var e = Jx;
            delete Gx[t.id];
            for (var n = 0; n < Gx.length; n++) if (Gx[n] === t) {
                Gx.splice(n, 1);
                break
            }
    ...
    Kx(Bx = {
        ...
        setup: function () {
            var e, t, n, r, o = "";
            if (t = dx.getDocumentBaseUrl(document.location), /^[^:]+:\/\/\/?[^\/]+\//.test(t) && (t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(t) || (t += "/")), n = window.tinymce || window.tinyMCEPreInit) e = n.base || n.baseURL, o = n.suffix; else {
        ...
        add: function (e) {
            var t = this;
            return Gx[e.id] === e || (null === t.get(e.id) && ("length" !== e.id && (Gx[e.id] = e), Gx.push(e), Jx.push(e)), Zx(!0), t.activeEditor = e, t.fire("AddEditor", {editor: e}), _x || (_x = function () {
                t.fire("BeforeUnload")
        ...
        remove: function (e) {
            ...
            })) : (n = e, k.isNull(r.get(n.id)) ? null : (ew(n) && r.fire("RemoveEditor", {editor: n}), 0 === Jx.length && jx.unbind(window, "beforeunload", _x), n.remove(), Zx(0 < Jx.length), n));
    ...
    var ow, iw, aw = rw, uw = Math.min, sw = Math.max, cw = Math.round, lw = function (e, t, n) {
        var r, o, i, a, u, s;
        ...
        inflate: function (e, t, n) {
            ...
            var o, i;
            for (i = 0; i < r.length; i++) if ((o = lw(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
            return null
        ...
        add: function (e, t) {
            ...
            var t = e.toLowerCase(), n = mw.hasOwnProperty(t) ? mw[t] : null;
    ...
    }, gw = It.each, hw = It.extend, vw = function () {
    };
    vw.extend = ow = function (n) {
        var e, t, r, o = this.prototype, i = function () {
            var e, t, n;
            if (!iw && (this.init && this.init.apply(this, arguments), t = this.Mixins)) for (e = t.length; e--;) (n = t[e]).init && n.init.apply(this, arguments)
        }, a = function () {
            return this
        }, u = function (n, r) {
            return function () {
    ...
    var yw = Math.min, bw = Math.max, Cw = Math.round, xw = function (e, n) {
        var r, o, t, i;
        ...
        callbacks: {}, count: 0, send: function (t) {
            var n = this, r = vi.DOM, o = t.count !== undefined ? t.count : n.count, i = "tinymce_jsonp_" + o;
    ...
    It.extend(Ew, Xm);
    var Sw = It.extend, kw = function (e) {
    ...
    var Tw, Aw = window.localStorage, Rw = nw, _w = {
        geom: {Rect: dw},
        util: {
            Promise: ye,
            Delay: we,
    ...
    Tw = Bw, window.tinymce = Tw, window.tinyMCE = Tw, function (e) {
