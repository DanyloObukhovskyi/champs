            ...
            <div class="colx2">
                <div class="col-item">
                    ...
                    <div class="input" id="input">
                        <input type="text" class="fw-600 input2_txt" name="discord" title="введите правильный">
                    </div>
                </div>
                <div class="col-item">
                ...
                <div class="col-item">
                    ...
                    <div class="input mb-5" id="input">
                        <input required type="text" class="fw-600 input2_txt" name="rank" placeholder="" title="введите правильный"
                               onkeyup="this.value = this.value.replace(/[^0-9\.,]/g, '')">
                    </div>
                    <div class="mb-15">
                        <img src="<?php print base_url("assets/icons/info.svg"); ?>"/>
