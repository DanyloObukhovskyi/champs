<main class="flex create-new-website-page">
    ...
    <div class="main-content">
        ...
        <form action="<?php print base_url("c-admin/trainer/add/" . $UserID); ?>" method="post"
            ...
            <div class="colx2" id="change-password-form">
                ...
                <div class="col-item" id="new_change">
                    ...
                    <div class="input mb-10">
                        <input required type="password" name="new_confirm" value="" id="new_confirm"
                               placeholder="************" title="Invalid password confirm" pattern="^.{8}.*$"
                               style="background-image: url(data:image/png;base64,); background-attachment: scroll; background-size: 16px 18px; cursor: auto; background-position: 98% 50%; background-repeat: no-repeat no-repeat;">
                    </div>
                </div>
            </div>
            ...
            <div class="colx2">
                <div class="col-item">
                    ...
                    <div class="input mb-5" id="input">
                        <input required type="text" class="fw-600 input2_txt" name="price" id="price"
                               placeholder="100руб./час" title="введите правильный "
                ...
                <div class="col-item">
                    ...
                    <div class="input mb-20" id="input">
                        <input required type="text" class="fw-600 input2_txt" name="video_url" id="video_url"
                ...
                <div class="col-item">
                    ...
                    <div class="input mb-5" id="input">
                        <input required type="text" class="fw-600 input2_txt" name="admin_percentage"
                               id="admin_percentage" placeholder="" title="введите правильный"
                               onkeyup="this.value = this.value.replace(/[^0-9\.,]/g, '')">
                    </div>
                    <div class="mb-15">
                        <img src="<?php print base_url("assets/icons/info.svg"); ?>"/>
