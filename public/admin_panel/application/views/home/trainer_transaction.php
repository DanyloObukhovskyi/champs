...
<main class="flex create-new-website-page">
    ...
    <?php } ?>
    <aside>
        <?php $activePath = 'trainers/transactions' ?>
    ...
    const app = new Vue({
        ...
        methods: {
            getTransactions() {
                ...
                axios.post('<?php echo base_url('c-admin/ajax/trainers/transactions');?>', form)
                    .then(({data}) => {
            ...
            save() {
                ...
                axios.post('<?php echo base_url('c-admin/ajax/trainers/transactions/save');?>', form)
                    .then(() => {
                        this.getTransactions()
                        Swal.fire({
                            icon: 'success',
