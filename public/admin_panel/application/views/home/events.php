        ...
        <div class="relative">
            <table class="new-table" id="eventsTable">
                ...
                <tr>
                    ...
                    <td class="width-5">Название</td>
                    <td class="width-20">Дата начала</td>
                    <td class="width-20">Дата конца</td>
                    <td class="width-20">Приз</td>
                    <td class="width-20">Локация</td>
...
<!--                                    <a :href="'--><?php //echo base_url('c-admin/events/edit/'); ?>
<!--//                                       class="btn btn-dark-blue btn-small">-->
<!--//                                        Редактировать-->
<!--//                                    </a>-->
<!--//                                    <a :href="'--><?php ////echo base_url('c-admin/events/delete/'); ?>
...
<script>
    $(document).ready( function () {
        $('#eventsTable').DataTable({
            ...
            "ordering": true,
            "ajax": {
                url: '<?php echo base_url('/c-admin/ajax/events') ;?>',
                type: 'POST',
                data: {
