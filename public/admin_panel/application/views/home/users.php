		...
		<div class="relative">
			<table class="new-table">
				...
				<tr>
					...
					<td class="width-5"><a href="<?php print base_url('c-admin/users/page/1?sort[email]='.($sort_email == 'asc' ? 'desc' : 'asc')); ?>"class="table-head-col"> Фото</a></td>
					<td class="width-35"><a href="<?php print base_url('c-admin/users/page/1?sort[roles]='.($sort_type == 'asc' ? 'desc' : 'asc')); ?>"class="table-head-col">Никнейм</a></td>
