						...
						<?php if (!empty($posts)) {
							...
							foreach ($posts AS $key => $val) {
								...
								<tr>
									...
									<td class="js-expand-table-item pointer" data-id="<?php echo $rmo_i; ?>"><img class="pr-10" style="vertical-align: middle;" src="<?php print base_url('assets/img/news_type/'.$val['type_img']); ?>"/><?php print $Type; ?></td>
