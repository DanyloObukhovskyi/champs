<main class="flex create-new-website-page">
	...
	<aside>
		<ul>
			...
			<li><a href="<?php echo base_url('c-admin/trainers/page/1'); ?>">Тренеры</a></li>
						...
						<?php if (!empty($posts)) {
							...
							foreach ($posts AS $key => $val) {
								...
								<tr>
									...
									<td class="t-a-r pr-15"><a class="pointer" href="<?php print base_url("c-admin/post/edit/".$val['id']."/".$UserID); ?>"><button class="btn btn-dark-blue btn-small">Редактировать</button></a> <a href="<?php print base_url("c-admin/post/delete/".$val['id']."/".$UserID); ?>" class="pointer txt-orange ml-15 fw-600">Удалить</a></td>
