    ...
    <div class="main-content">
        ...
        <div class="relative">
            <table class="new-table">
                ...
                <tr>
                    <td class="width-15"><a
                                href="<?php print base_url('c-admin/matches/page/1?sort[start_at]=' . ($sort_id == 'asc' ? 'desc' : 'asc')); ?>"
                                class="table-head-col"> Дата</a></td>
                    <td class="width-15"><a
                                href="<?php print base_url('c-admin/matches/page/1?sort[start_at]=' . ($sort_id == 'asc' ? 'desc' : 'asc')); ?>"
                                class="table-head-col"> Время</a></td>
                    <td class="width-25"><a
                                href="<?php print base_url('c-admin/matches/page/1?sort[team1_id]=' . ($team1_sid == 'asc' ? 'desc' : 'asc')); ?>"
                                class="table-head-col">Команда 1</a></td>
                    <td class="width-25"><a
                                href="<?php print base_url('c-admin/matches/page/1?sort[team2_id]=' . ($team2_sid == 'asc' ? 'desc' : 'asc')); ?>"
                                class="table-head-col">Команда 2</a></td>
                    ...
                    foreach ($statistics as $key => $val) {
                        ...
                        <tr>
                            ...
                            <td class="js-expand-table-item pointer"
                                data-id="<?php echo $rmo_i; ?>"><?php print  date("H:i", strtotime($val["start_at"])); ?></td>
                            <td class="js-expand-table-item pointer" data-id="<?php echo $rmo_i; ?>"><img
                                        class="profile-pic-small"
                                        src="<?php print isset($team1['logo']) ? $imgs_url . $team1['logo'] : ''; ?>"/>
                                <div class="pl-10"
                                     style="display: inline-block;"><?php print (isset($team1['name'])) ? $team1['name'] : ''; ?></div>
                            </td>
                            <td class="js-expand-table-item pointer" data-id="<?php echo $rmo_i; ?>"><img
                                        class="profile-pic-small"
                                        src="<?php print isset($team2['logo']) ? $imgs_url . $team2['logo'] : ''; ?>"/>
                                <div class="pl-10"
                                     style="display: inline-block;"><?php print (isset($team2['name'])) ? $team2['name'] : ''; ?></div>
                            </td>
                            <td class="t-a-r pr-15"><a href="https://champs.pro/ru/match/<?php print $val['id']; ?>">
                                    <button class="btn btn-dark-blue btn-small">Редактировать</button>
                                </a>
                                <div onclick="c_delete(<?php print "'" . base_url("c-admin/match/delete/") . $val['id'] . "/" . $UserID . "'"; ?>,<?php print "'" . $val["start_at"] . "'"; ?>,'Match')"
