        ...
        <form action="<?php print base_url("c-admin/trainer/edit/" . $user_info[0]['userid'] . "/" . $UserID); ?>"
                ...
                <div class="col-item">
                    ...
                    <div class="input mb-5" id="input">
                        <input required type="text" class="fw-600 input2_txt" name="nickname" id="nickname"
                               placeholder="Example: nickname3456789" title="введите правильный никнейм"
                               value="<?php print $user_info[0]['nickname']; ?>">
                    ...
                    <div class="input mb-5" id="input">
                        <input required type="text" class="fw-600 input2_txt" name="Email" id="mail"
                               placeholder="Example: example@example.com" title="введите правильный E-mail"
                               value="<?php print $user_info[0]['email']; ?>">
            ...
            <div class="colx2" id="change-password-form">
                <div class="col-item">
                    ...
                    <div class="input mb-10">
                        <input type="password" name="new_password" id="new" placeholder="************"
            ...
            <div class="colx2">
                <div class="col-item">
                    ...
                    <div class="input" id="input">
                        <input type="text" class="fw-600 input2_txt" name="discord"
                               value="<?php print $user_info[0]['discord']; ?>" title="введите правильный">
                    </div>
                </div>
                <div class="col-item">
                        ...
                        <?php foreach ($achievements as $key => $achievement): ?>
                            <div class="achievement_input" id="achievement_<?php echo $key; ?>" data-key="<?php echo $key + 1; ?>">
                                <div class="achievement_input_wrapper">
                                    <div class="col-item">
                                        ...
                                        <div class="input mb-5">
                                            <input type="text"
                                                   class="fw-600 input2_txt"
                                                   value="<?php echo $achievement['tournament']; ?>"
                                                   name="achievements[<?php echo $key; ?>][event]">
                                        </div>
                                    </div>
                                    <div class="col-item">
                                        <label class="label">Достижение</label>
                                        <div class="input mb-5">
                                            <input type="text"
                                                   class="fw-600 input2_txt"
                                                   value="<?php echo $achievement['achievement']; ?>"
                                                   name="achievements[<?php echo $key; ?>][achievement]">
                                        </div>
                                    </div>
                                </div>
                                <div class="achievement_input_footer">
                                    <button type="button"
                                            class="btn btn-orange remove-video"
                                            onclick="removeAchievement('<?php echo $key; ?>')">
                                        <img width="25px"
                                             src="data:image/svg+xml;base64,"/>
                                    </button>
                                    <div>
            ...
            <div class="colx2">
                ...
                <div class="flex">
                    ...
                    <a href="<?php print base_url("c-admin/trainer/delete/" . $user_info[0]['userid'] . "/" . $UserID); ?>"
                       class="changePass mt-25" style="height: 36px;top: -9px; position: relative">
    ...
    function addAchievement() {
        ...
        <div class="achievement_input" id="achievement_${key}" data-key="${key}">
            <div class="achievement_input_wrapper">
                ...
                <div class="col-item">
                    <label class="label" for="">Достижение</label>
                    <div class="input mb-5">
    ...
    function selectAchievement() {
        if ($('#achievements .checkbox input:checkbox:checked').length === 4) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Упс...',
                text: 'Можно выбрать только 3 достижения!',
            })
        }
    }
